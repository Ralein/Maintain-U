    ...
    <div className="min-h-screen px-6 pt-6 pb-32 bg-background">
      ...
      {stats.pendingTechs > 0 && (
        <div
          ...
          className="group relative overflow-hidden p-4 rounded-xl bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-950/40 dark:to-orange-950/40 border border-red-200 dark:border-red-900 mb-6 cursor-pointer shadow-sm hover:shadow-md transition-all"
        >
